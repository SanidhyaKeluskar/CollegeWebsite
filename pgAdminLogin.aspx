<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgAdminLogin.aspx.cs" Inherits="pgAdminLogin" %>
...
<head>
    ...
    <title>College Social : Admin Login</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="pgAdminLogin.aspx">Admin Login</a> 
            </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
				    ...
				    <li>
                        <a  href="pgTeacherReg.aspx"><i class=""></i>Registration</a>
                    </li>
                </ul>
