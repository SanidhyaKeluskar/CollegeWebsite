<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgStudAnnouncement.aspx.cs" Inherits="pgStudAnnouncement" %>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    SelectCommand="SELECT [info], [AStatus], [ADate] FROM [TeacherAnnouncement]">
                </asp:SqlDataSource>
