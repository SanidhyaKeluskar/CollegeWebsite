<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgStudLogin.aspx.cs" Inherits="pgStudLogin" %>
...
<head>
    ...
    <title>College Social : Student Login</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="pgStudLogin.aspx">Student Login</a> 
            </div>
        </nav>   
           <!-- /. NAV TOP  -->
